(function () {
  ...
  function actionKind(text) {
    ...
    if (/compress|resize|convert|generate|remove|merge|split|extract|calculate|estimate|test|start|run|create|scan|analyze|clean|format|render|reset|pack|inventory|readiness|pulse|refresh|watch|pantry|recall|shortage/.test(text)) return "tool_action";
    return "";
  }
